...
const pages = ['NEW', 'WOMEN', 'MEN', 'ACCESSORIES', 'SALE'];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Box sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }}>
            <img src='https://sunrise-spa.vercel.app/img/logo.6528bde1.svg' width={"100px"}/>
          </Box>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            <span style={{position: "relative",top: "7px",left: "5px"}}>
              <span style={{position: "absolute",top: "-24px",right: "7px"}}>0</span>
